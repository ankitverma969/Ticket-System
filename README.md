...
A robust, production-ready Ticket System backend implemented in **Go** using the **chi router**, **MongoDB** (official Go driver), and **JWT authentication**.

## 🌐 Public Deployment URLs
- **Deployment URL**: `TO BE ADDED AFTER DEPLOYMENT` (e.g. `https://ticket-system.onrender.com`)
- **Public Health URL**: `TO BE ADDED AFTER DEPLOYMENT/health` (e.g. `https://ticket-system.onrender.com/health`)
